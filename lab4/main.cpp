...
int main(int argc, char const *argv[])
{
  ...
  std::printf("Generating %dx%d grid\n", m, n);
  ...
  std::shared_ptr<Domain> myDomain_ptr = std::make_shared<Domain>(myDomain);
  GFkt myGFkt_1 = GFkt(myDomain_ptr);
  GFkt myGFkt_2 = GFkt(myGFkt_1);
  // GFkt myGFkt_2 = GFkt(myDomain_ptr);
